...
##Inserting planets to the solar_system
    ...
    def draw_planets(self):
        ...
        for index, planet in enumerate(self.planets):
            ...
            t.goto(x, y)
            t.pendown()
            # Scale the planet radius for drawing and use the color 
            t.dot(planet.radius/900 , planet.color)  
...
# The stars will be added based on its size compared to the sun, if smaller than the sun it will be added to smaller
